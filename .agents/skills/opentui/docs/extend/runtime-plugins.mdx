...
skill:
  entry: true
  intents:
    [runtime-plugins, dynamic-import, external-modules, bun-plugin, module-maps, plugin-loading]
---
...
const registry = createCoreSlotRegistry<"statusbar", typeof context, { label: string }>(
  renderer,
  context,
);
